...
<body>
    ...
    <header class="navbar sticky-top flex-md-nowrap p-0 shadow mb-3" style="background-color: #D2DFBD;">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-5" style="background-color: #D2DFBD;" ><b>Admin</b></a>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse  mt-3">
                <div class="position-sticky pt-3 px-4">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('admin/pendaftaran*') ? 'active' : '' }}"
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('admin/capaian*') ? 'active' : '' }}"
                                href="/admin/capaian">
