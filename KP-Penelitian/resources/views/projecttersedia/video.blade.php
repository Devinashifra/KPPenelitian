...
<body>
    ...
    <center><h6>Tentang Pembuatan Video Tutorial dan Penggunaan Aplikasi</h6></center>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th scope="col">Platform Penayangan</th>
                </tr>
            </thead>
            <tbody class="table-group-divider">
                <tr>
                    <th scope="row">1</th>
                    <td>Cara melakukan Pengaduan JSS</td>
                    <td>Tiktok</td>
                </tr>
                <tr>
                    <th scope="row">2</th>
                    <td>Cara memasang iklan di layanan dodolan (JSS)</td>
                    <td>Tiktok</td>
                </tr>
            </tbody>
        </table>
