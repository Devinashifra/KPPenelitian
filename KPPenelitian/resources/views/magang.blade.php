...
<body>
        ...
        <div class="col-sm-2">
            <div class="card text-center">
                <img src="{{ asset ('icon') }}/templet.png" class="card-img-top" alt="">
                    <div class="card-body">
                        <a href="https://docs.google.com/presentation/d/1mymIbAeL2QRE2uNXLcTcL9M8_zSLE_JrdP5qUnjXu6M/edit#slide=id.p" class="btn"><b>Template Presentasi</b></a>
                    </div>
            </div>
        </div>
        <div class="col-sm-2">
        ...
        <div class="col-sm-2">
            <div class="card text-center">
                <img src="{{ asset ('icon') }}/proter.png" class="card-img-top" alt="">
                    <div class="card-body">
                        <a href="https://docs.google.com/spreadsheets/d/1SmPtG7gdZvH0cob_vggxbMWwueniDJnPr56e0x2bibk/edit#gid=0" class="btn"><b>Project Tersedia</b></a>
                    </div>
            </div>
        </div>
        <div class="col-sm-2">
    ...
    <footer class="p-3 mt-3" style=" background-color: #D2DFBD">
        <div class="footer">
